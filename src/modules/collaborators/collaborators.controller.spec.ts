...
describe('CollaboratorsController', () => {
  ...
  describe('create', () => {
    it('should be able to create a new collaborator', async () => {
      ...
      const response = await controller.create(projectId, {userId: 'user-1', role: 'EDITOR'})
  ...
  it('should be able to handle validation errors', async () => {
    ...
    await expect(controller.create(projectId, { userId: ''})).rejects.toThrow(error)
  })
  ...
  describe('update', () => {
    it('should be able to update a collaborator', async () => {
      ...
      const response = await controller.update(projectId, collaborator.id, {role: 'OWNER'})
