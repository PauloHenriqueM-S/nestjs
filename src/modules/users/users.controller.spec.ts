...
describe('UsersController', () => {
  ...
  describe('findAll', () => {
    it('should return a paginated list of users', async () => {
      ...
      jest.spyOn(service, 'findAll').mockReturnValue(mockedResponse)
  ...
  describe('create', () => {
    it('should create a new user', async () => {
      const user = mockedUsers[0]
      jest.spyOn(service, 'create').mockReturnValue(user)
    ...
    it('should handle validation errors', async () => {
      ...
      await expect(controller.create({ name: '', email: '', password: '' })).rejects.toThrow(error)
    })
  })
  ...
  describe('uploadAbatar', () => {
    it('should upload and update user', async () => {
      const user = mockedUsers[0]
