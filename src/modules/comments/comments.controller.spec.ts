...
describe('CommentsController', () => {
  ...
  describe('create', () => {
    it('should be able to create a new comment', async () => {
      ...
      const response = await controller.create(taskId, { content: 'New comment' })
    ...
    it('should be able to handle validation errors', async () => {
      ...
      await expect(controller.create(taskId, { content: '' })).rejects.toThrow(error)
    })
  })
  ...
  describe('update', () => {
    it('should be able to update a comment', async () => {
      ...
      const response = await controller.update(taskId, comment.id, { content: 'Updated comment' })
