...
describe('AuthService', () => {
  ...
  describe('signin', () => {
    ...
    it('should return an exception if credential are wrong', async () => {
      const user = mockedUsers[0]
  ...
  describe('forgotPassword', () => {
    ...
    it('should be able to reset the password form e-mail link', async () => {
      ...
      jest.spyOn(jwtService, 'verify').mockReturnValue({ purpose: 'password_reset' })
    ...
    it('should throw an error if the token is invalid', async () => {
      jest.spyOn(jwtService, 'verify').mockReturnValue({ purpose: 'test' })
